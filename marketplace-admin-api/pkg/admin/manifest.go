...
// never drift from the hash the install pins against. Copied from the
// catalog's reading of the same bytes: the two surfaces must describe one
// version identically.
...
// Collapses RBAC verbs into the two phrases the backoffice shows. bind,
