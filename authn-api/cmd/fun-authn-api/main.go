...
type config struct {
	...
	RedirectURL        string        `env:"OIDC_REDIRECT_URL,required,notEmpty" envDefault:"http://authn.fundament.localhost:10080/callback"`
	FrontendURL        string        `env:"FRONTEND_URL,required,notEmpty" envDefault:"http://console.fundament.localhost:10080"`
	...
	ListenAddr         string        `env:"LISTEN_ADDR" envDefault:":10080"`
	TokenExpiry        time.Duration `env:"TOKEN_EXPIRY" envDefault:"24h"`
	LogLevel           slog.Level    `env:"LOG_LEVEL" envDefault:"info"`
	CORSAllowedOrigins []string      `env:"CORS_ALLOWED_ORIGINS" envDefault:"http://localhost:5173,http://localhost:4200,http://console.fundament.localhost:10080"`
}
