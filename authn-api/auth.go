...
func New(logger *slog.Logger, cfg *config.Config, oauth2Config *oauth2.Config, verifier *oidc.IDTokenVerifier, sessionStore *session.SessionStore, store *storage.Storage) (*AuthnServer, error) {
	return &AuthnServer{
		config:       cfg,
