...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/fundament-oss/fundament/authn-api/pkg/proto/gen/authn/v1"
	http "net/http"
	strings "strings"
)
...
func NewTokenServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) TokenServiceClient {
	...
	return &tokenServiceClient{
		...
		mintPluginToken: connect.NewClient[v1.MintPluginTokenRequest, v1.MintPluginTokenResponse](
			httpClient,
			baseURL+TokenServiceMintPluginTokenProcedure,
