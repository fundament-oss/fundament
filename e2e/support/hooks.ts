...
Before({ tags: '@api' }, async function (this: ICustomWorld) {
  this.organizationApiUrl = process.env.ORGANIZATION_API_URL || 'http://organization.fundament.localhost:10080';
  this.authnApiUrl = process.env.AUTHN_API_URL || 'http://authn.fundament.localhost:10080';
