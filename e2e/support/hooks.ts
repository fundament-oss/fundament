...
Before({ tags: '@api' }, async function (this: ICustomWorld) {
  this.organizationApiUrl = process.env.ORGANIZATION_API_URL || 'https://organization.fundament.localhost:10443';
  this.authnApiUrl = process.env.AUTHN_API_URL || 'https://authn.fundament.localhost:10443';
