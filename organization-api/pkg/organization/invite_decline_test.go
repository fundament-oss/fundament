...
func Test_DeclineInvitation_Unauthenticated(t *testing.T) {
	t.Parallel()
...
func Test_DeclineInvitation_DoesNotExist(t *testing.T) {
	t.Parallel()
...
func Test_DeclineInvitation_HappyFlow(t *testing.T) {
	t.Parallel()
