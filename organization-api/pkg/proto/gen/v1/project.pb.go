...
type AttachNamespaceRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	ProjectId     string                 `protobuf:"bytes,10,opt,name=project_id,json=projectId,proto3" json:"project_id,omitempty"`
	NamespaceId   string                 `protobuf:"bytes,20,opt,name=namespace_id,json=namespaceId,proto3" json:"namespace_id,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *AttachNamespaceRequest) Reset() {
	*x = AttachNamespaceRequest{}
	mi := &file_v1_project_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *AttachNamespaceRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AttachNamespaceRequest) ProtoMessage() {}

func (x *AttachNamespaceRequest) ProtoReflect() protoreflect.Message {
	mi := &file_v1_project_proto_msgTypes[9]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AttachNamespaceRequest.ProtoReflect.Descriptor instead.
func (*AttachNamespaceRequest) Descriptor() ([]byte, []int) {
	return file_v1_project_proto_rawDescGZIP(), []int{9}
}

func (x *AttachNamespaceRequest) GetProjectId() string {
	if x != nil {
		return x.ProjectId
	}
	return ""
...
func (x *AttachNamespaceRequest) GetNamespaceId() string {
	if x != nil {
...
type DetachNamespaceRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	ProjectId     string                 `protobuf:"bytes,10,opt,name=project_id,json=projectId,proto3" json:"project_id,omitempty"`
	NamespaceId   string                 `protobuf:"bytes,20,opt,name=namespace_id,json=namespaceId,proto3" json:"namespace_id,omitempty"`
	unknownFields protoimpl.UnknownFields
...
func (x *DetachNamespaceRequest) Reset() {
	*x = DetachNamespaceRequest{}
	mi := &file_v1_project_proto_msgTypes[10]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *DetachNamespaceRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DetachNamespaceRequest) ProtoMessage() {}

func (x *DetachNamespaceRequest) ProtoReflect() protoreflect.Message {
	mi := &file_v1_project_proto_msgTypes[10]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DetachNamespaceRequest.ProtoReflect.Descriptor instead.
func (*DetachNamespaceRequest) Descriptor() ([]byte, []int) {
	return file_v1_project_proto_rawDescGZIP(), []int{10}
}

func (x *DetachNamespaceRequest) GetProjectId() string {
	if x != nil {
		return x.ProjectId
	}
	return ""
...
func (x *DetachNamespaceRequest) GetNamespaceId() string {
	if x != nil {
		return x.NamespaceId
	}
	return ""
...
func (x *ProjectNamespace) GetAttachedAt() *Timestamp {
	if x != nil {
		return x.AttachedAt
	}
	return nil
...
const file_v1_project_proto_rawDesc = "" +
	...
	"project_id\x18\n" +
	" \x01(\tR\tprojectId\"Z\n" +
	"\x16AttachNamespaceRequest\x12\x1d\n" +
	"\n" +
	"project_id\x18\n" +
	" \x01(\tR\tprojectId\x12!\n" +
	"\fnamespace_id\x18\x14 \x01(\tR\vnamespaceId\"Z\n" +
	"\x16DetachNamespaceRequest\x12\x1d\n" +
	"\n" +
	"project_id\x18\n" +
	" \x01(\tR\tprojectId\x12!\n" +
	"\fnamespace_id\x18\x14 \x01(\tR\vnamespaceId\"=\n" +
	...
	"\rDeleteProject\x12%.organization.v1.DeleteProjectRequest\x1a\x16.google.protobuf.Empty\x12R\n" +
	"\x0fAttachNamespace\x12'.organization.v1.AttachNamespaceRequest\x1a\x16.google.protobuf.Empty\x12R\n" +
	"\x0fDetachNamespace\x12'.organization.v1.DetachNamespaceRequest\x1a\x16.google.protobuf.Empty\x12o\n" +
	"\x0eListNamespaces\x12-.organization.v1.ListProjectNamespacesRequest\x1a..organization.v1.ListProjectNamespacesResponseBUZSgithub.com/fundament-oss/fundament/organization-api/pkg/proto/gen/v1;organizationv1b\x06proto3"
...
var file_v1_project_proto_msgTypes = make([]protoimpl.MessageInfo, 14)
var file_v1_project_proto_goTypes = []any{
	...
	(*AttachNamespaceRequest)(nil),        // 9: organization.v1.AttachNamespaceRequest
	(*DetachNamespaceRequest)(nil),        // 10: organization.v1.DetachNamespaceRequest
	...
	(*Timestamp)(nil),                     // 14: organization.v1.Timestamp
...
var file_v1_project_proto_depIdxs = []int32{
	...
	14, // 2: organization.v1.Project.created_at:type_name -> organization.v1.Timestamp
	13, // 3: organization.v1.ListProjectNamespacesResponse.namespaces:type_name -> organization.v1.ProjectNamespace
	14, // 4: organization.v1.ProjectNamespace.attached_at:type_name -> organization.v1.Timestamp
	...
	9,  // 10: organization.v1.ProjectService.AttachNamespace:input_type -> organization.v1.AttachNamespaceRequest
	10, // 11: organization.v1.ProjectService.DetachNamespace:input_type -> organization.v1.DetachNamespaceRequest
	11, // 12: organization.v1.ProjectService.ListNamespaces:input_type -> organization.v1.ListProjectNamespacesRequest
	1,  // 13: organization.v1.ProjectService.ListProjects:output_type -> organization.v1.ListProjectsResponse
	3,  // 14: organization.v1.ProjectService.GetProject:output_type -> organization.v1.GetProjectResponse
	6,  // 15: organization.v1.ProjectService.CreateProject:output_type -> organization.v1.CreateProjectResponse
	15, // 16: organization.v1.ProjectService.UpdateProject:output_type -> google.protobuf.Empty
	15, // 17: organization.v1.ProjectService.DeleteProject:output_type -> google.protobuf.Empty
	15, // 18: organization.v1.ProjectService.AttachNamespace:output_type -> google.protobuf.Empty
	15, // 19: organization.v1.ProjectService.DetachNamespace:output_type -> google.protobuf.Empty
	12, // 20: organization.v1.ProjectService.ListNamespaces:output_type -> organization.v1.ListProjectNamespacesResponse
