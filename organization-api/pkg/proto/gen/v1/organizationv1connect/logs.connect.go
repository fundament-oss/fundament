...
type LogsServiceClient interface {
	...
	TailLogs(context.Context, *v1.TailLogsRequest) (*connect.ServerStreamForClient[v1.LogEntry], error)
...
func (c *logsServiceClient) QueryLogs(ctx context.Context, req *v1.QueryLogsRequest) (*v1.QueryLogsResponse, error) {
...
func (c *logsServiceClient) TailLogs(ctx context.Context, req *v1.TailLogsRequest) (*connect.ServerStreamForClient[v1.LogEntry], error) {
	return c.tailLogs.CallServerStream(ctx, connect.NewRequest(req))
}

// GetLogLabels calls organization.v1.LogsService.GetLogLabels.
func (c *logsServiceClient) GetLogLabels(ctx context.Context, req *v1.GetLogLabelsRequest) (*v1.GetLogLabelsResponse, error) {
	response, err := c.getLogLabels.CallUnary(ctx, connect.NewRequest(req))
	if response != nil {
		return response.Msg, err
	}
	return nil, err
...
type LogsServiceHandler interface {
	...
	QueryLogs(context.Context, *v1.QueryLogsRequest) (*v1.QueryLogsResponse, error)
	// TailLogs streams new log entries as they arrive (live tail).
	TailLogs(context.Context, *v1.TailLogsRequest, *connect.ServerStream[v1.LogEntry]) error
	// GetLogLabels returns the distinct label values (namespaces, pods,
	// containers) available for a cluster, used to populate filter dropdowns.
	GetLogLabels(context.Context, *v1.GetLogLabelsRequest) (*v1.GetLogLabelsResponse, error)
}
...
func NewLogsServiceHandler(svc LogsServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	logsServiceMethods := v1.File_v1_logs_proto.Services().ByName("LogsService").Methods()
	logsServiceQueryLogsHandler := connect.NewUnaryHandlerSimple(
		LogsServiceQueryLogsProcedure,
		svc.QueryLogs,
		connect.WithSchema(logsServiceMethods.ByName("QueryLogs")),
		connect.WithHandlerOptions(opts...),
	)
	logsServiceTailLogsHandler := connect.NewServerStreamHandlerSimple(
		LogsServiceTailLogsProcedure,
		svc.TailLogs,
		connect.WithSchema(logsServiceMethods.ByName("TailLogs")),
		connect.WithHandlerOptions(opts...),
	)
	logsServiceGetLogLabelsHandler := connect.NewUnaryHandlerSimple(
...
func (UnimplementedLogsServiceHandler) QueryLogs(context.Context, *v1.QueryLogsRequest) (*v1.QueryLogsResponse, error) {
...
func (UnimplementedLogsServiceHandler) TailLogs(context.Context, *v1.TailLogsRequest, *connect.ServerStream[v1.LogEntry]) error {
