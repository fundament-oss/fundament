...
import (
	...
	organizationv1 "github.com/fundament-oss/fundament/organization-api/proto/gen/organization/v1"
)
...
func New(logger *slog.Logger, cfg *config.Config, store *storage.Storage) (*OrganizationServer, error) {
