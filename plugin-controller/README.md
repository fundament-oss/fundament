...
See [docs/developer/plugins](../docs/developer/plugins/index.md) for full documentation on the plugin system, SDK, controller architecture, and the development sandbox.
