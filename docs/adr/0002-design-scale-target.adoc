...
Design for 50,000 physical servers / ~2,000,000 logical CPUs across 3+ sites, to be reached within 3 years. All architecture decisions must be validated against this target.
