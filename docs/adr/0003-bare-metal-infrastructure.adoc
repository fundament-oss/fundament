...
Fundament needs a compute foundation for multi-tenant Kubernetes. Government requirements: data residency within the EU, full-stack auditability, no dependency on non-European vendors.
