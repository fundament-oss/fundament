...
The default body text size is `text-base`. Use `text-3xl font-semibold` for page titles, `text-lg` for section headings, and `text-xs` for badges and helper text. Use `font-mono` for technical identifiers such as UUIDs and tokens.
