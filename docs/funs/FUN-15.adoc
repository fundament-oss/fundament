...
The nginx configuration sets strict CSP headers for the console. For the plugin UI path, a separate location block relaxes only the one directive that must differ:
