...
CREATE UNIQUE INDEX organizations_users_uq_user ON tenant.organizations_users USING btree (organization_id, user_id, deleted) NULLS NOT DISTINCT;

ALTER TABLE "tenant"."organizations_users" ADD CONSTRAINT "organizations_users_uq_user" UNIQUE USING INDEX "organizations_users_uq_user";
...
ALTER TABLE "authz"."outbox" ADD CONSTRAINT "outbox_ck_single_fk" CHECK((num_nonnulls(user_id, project_id, project_member_id, cluster_id, node_pool_id, namespace_id, api_key_id, install_id, organization_user_id) = 1)) NOT VALID;
...
SELECT organization_id, id, role FROM "tenant"."users";
...
*/
CREATE UNIQUE INDEX users_uq_external_ref ON tenant.users USING btree (external_ref, deleted) NULLS NOT DISTINCT;

ALTER TABLE "tenant"."users" ADD CONSTRAINT "users_uq_external_ref" UNIQUE USING INDEX "users_uq_external_ref";
