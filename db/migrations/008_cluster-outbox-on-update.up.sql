...
ALTER INDEX "tenant"."cluster_outbox_idx_cluster_id" RENAME TO "pgschemadiff_tmpidx_cluster_outbox_idx_c_IXNRSkC9TOusONJFW69PKw";
...
*/
DROP INDEX "tenant"."pgschemadiff_tmpidx_cluster_outbox_idx_c_IXNRSkC9TOusONJFW69PKw";
