...
CREATE TABLE tenant.users (
	...
	CONSTRAINT users_uq_external_ref UNIQUE NULLS NOT DISTINCT (external_ref,deleted)
);
-- ddl-end --
...
CREATE TABLE tenant.organizations_users (
	...
	CONSTRAINT organizations_users_uq_user UNIQUE NULLS NOT DISTINCT (organization_id,user_id,deleted),
...
-- object: grant_r_321497c6de | type: PERMISSION --
GRANT SELECT
   ON TABLE tenant.organizations_users
   TO fun_authn_api;
