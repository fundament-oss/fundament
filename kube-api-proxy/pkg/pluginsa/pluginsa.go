...
type Resolver interface {
	Resolve(ctx context.Context, clusterID, installationID string) (Token, error)
}
...
// gardener.Client already satisfies this via ResolvePluginSA.
type Client interface {
	ResolvePluginSA(ctx context.Context, clusterID, installationName string) (*gardener.PluginSAToken, error)
}
...
func (Stub) Resolve(_ context.Context, _, _ string) (Token, error) {
...
func (r *PluginSA) Resolve(ctx context.Context, clusterID, installationID string) (Token, error) {
	sa, err := r.client.ResolvePluginSA(ctx, clusterID, installationID)
	if err != nil {
