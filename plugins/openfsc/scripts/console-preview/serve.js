...
// whether get needs -n.
const RESOURCES = {
  peers: { kind: 'peers.openfsc.fundament.io', namespaced: false },
  inways: { kind: 'inways.openfsc.fundament.io', namespaced: false },
  outways: { kind: 'outways.openfsc.fundament.io', namespaced: false },
};
