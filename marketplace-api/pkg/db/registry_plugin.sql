...
-- RegistryPluginUpdate, keeps a delete landing between a handler's lookup and
...
-- name: RegistryPluginDocLinkUpdate :execrows
...
-- name: RegistryPluginDocLinksSoftDeleteNotIn :exec
...
-- name: RegistryPluginFeatureUpdate :execrows
-- Mirrors RegistryPluginDocLinkUpdate: scoped by plugin_id as well as id, with
...
-- name: RegistryPluginFeaturesSoftDeleteNotIn :exec
