...
/**
 * Dispatcher for the resource create wizard.
 * Checks if the plugin has a custom createWizard component registered; falls back to ResourceCreateComponent.
 * Redirects to list if the user cannot write.
 */
@Component({
