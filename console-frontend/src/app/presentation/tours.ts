...
const marketplace: Tour = {
  ...
  slides: [
    ...
    },
    {
      ...
      // The project's own address carries no page, so the pane beside the menu
      // would read "No selection"; the overview is the quietest real page there
      // is, and the sidebar is what this slide is about.
      route: '/projects/pr-burgerzaken/general',
      drive: installedPluginDrive,
    },
    {
