...
func (m MockFetcher) Fetch(_ context.Context, clusterID uuid.UUID, pluginName, assetPath string) ([]byte, string, error) {
	m.Logger.Debug("mock asset fetch", "cluster", clusterID, "plugin", pluginName, "path", assetPath)
